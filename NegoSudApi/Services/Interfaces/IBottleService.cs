...
public interface IBottleService
{
    ...
    /// <returns>A Bottle object with the desired id, or null if it doesn't exist</returns>
    Task<Bottle?> GetBottleAsync(int id, bool includes = true);

    /// <summary>
    /// Get an IEnumerable of Bottles from the database
    /// </summary>
    /// <returns>A collection of Bottles object</returns>
    ...
    /// <returns>A Bottle object</returns>
