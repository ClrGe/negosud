...
public interface IProducerService
{
    ...
    /// <returns>A Producer model with the desired id, or null if it doesn't exist</returns>
    Task<Producer?> GetProducerAsync(int id, bool includes = true);

    /// <summary>
    /// Get an IEnumerable of Producers from the database
    /// </summary>
    /// <returns>A collection of Producer model</returns>
    ...
    /// <returns>A Producer model</returns>
