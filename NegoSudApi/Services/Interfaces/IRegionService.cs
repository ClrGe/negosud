...
public interface IRegionService
{
    ...
    /// <returns>A Region model with the desired id, or null if it doesn't exist</returns>
    Task<Region?> GetRegionAsync(int id, bool includes = true);

    /// <summary>
    /// Get an IEnumerable of Regions from the database
    /// </summary>
    /// <returns>A collection of Region model</returns>
    ...
    /// <returns>A Region model</returns>
