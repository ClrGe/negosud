...
public interface IStorageLocationService
{
    ...
    /// <returns>A StorageLocation model with the desired id, or null if it doesn't exist</returns>
    ...
    /// </summary>
    /// <returns>A collection of StorageLocation model</returns>
    ...
    /// <returns>A StorageLocation model</returns>
