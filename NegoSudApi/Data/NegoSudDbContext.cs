...
public class NegoSudDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Bottle>(entity =>
        {
            ...
            entity.Property(t => t.UpdatedAt).HasPrecision(0);
        ...
        modelBuilder.Entity<CustomerOrder>(entity =>
        {
            ...
            entity.Property(cO => cO.CreatedAt).HasPrecision(0).ValueGeneratedOnAdd();
            entity.Property(cO => cO.UpdatedAt).HasPrecision(0);
        ...
        modelBuilder.Entity<CustomerOrderLine>(entity =>
        {
            ...
            entity.Property(l => l.CreatedAt).HasPrecision(0).ValueGeneratedOnAdd();
            entity.Property(l => l.UpdatedAt).HasPrecision(0);
        ...
        modelBuilder.Entity<SupplierOrder>(entity =>
        {
            ...
            entity.Property(sO => sO.CreatedAt).HasPrecision(0).ValueGeneratedOnAdd();
            entity.Property(sO => sO.UpdatedAt).HasPrecision(0);
            entity.HasKey(cO => cO.Id);
            entity.Property(cO => cO.Id).UseIdentityColumn();
